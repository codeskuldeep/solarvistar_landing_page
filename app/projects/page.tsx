  ...
  return (
    <main className="w-full overflow-hidden">
      ...
      <PageHero
        eyebrow="Our Work"
        icon="photo_library"
        title={<>Projects &amp; <span className="text-solar-gradient">Gallery</span></>}
        subtitle="Real residential solar installations across Madhya Pradesh. Witness the transformation to sustainable living through our community of forward-thinking homeowners."
        image={images[0]}
        imageAlt="Solar Vistar installation gallery"
        stats={[
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
            <GlassCard className="!p-0 overflow-hidden flex flex-col h-full hover:shadow-xl transition-shadow border-outline-variant/30">
              ...
              <div className="p-8 flex flex-col flex-1">
                ...
                <p className="font-body-md text-on-surface-variant italic border-l-4 border-primary pl-4">&ldquo;Our summer AC bills were a nightmare. Now, we run two ACs guilt-free, and the cooperative handled all the PM Surya Ghar subsidy paperwork.&rdquo;</p>
              </div>
            </GlassCard>
            ...
            <GlassCard className="!p-0 overflow-hidden flex flex-col h-full hover:shadow-xl transition-shadow border-outline-variant/30">
              ...
              <div className="p-8 flex flex-col flex-1">
                ...
                <p className="font-body-md text-on-surface-variant italic border-l-4 border-solar-orange pl-4">&ldquo;Installing solar for our common areas was the best investment the society made. Solar Vistar&apos;s transparent pricing beat every private vendor.&rdquo;</p>
              </div>
            </GlassCard>
          </div>
        </div>
